...
export const BACKEND_PATHS = {
  ...
  DOWNLOADS: {
    ...
    COVER_PAGE: '/download/cover-page',
    SUBSIDY_DETAILS_LIST: '/download/subsidy-details-list',
...
export const API_MAPPING: Record<string, string> = {
  ...
  [DOWNLOADS.COVER_PAGE]: BACKEND_PATHS.DOWNLOADS.COVER_PAGE,
  [DOWNLOADS.SUBSIDY_DETAILS_LIST]: BACKEND_PATHS.DOWNLOADS.SUBSIDY_DETAILS_LIST,
