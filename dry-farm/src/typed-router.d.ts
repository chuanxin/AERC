...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/maps/components/MapFilterPanel': RouteRecordInfo<'/maps/components/MapFilterPanel', '/maps/components/MapFilterPanel', Record<never, never>, Record<never, never>>,
    '/maps/components/MapLayerPanel': RouteRecordInfo<'/maps/components/MapLayerPanel', '/maps/components/MapLayerPanel', Record<never, never>, Record<never, never>>,
    '/maps/components/MapPopup': RouteRecordInfo<'/maps/components/MapPopup', '/maps/components/MapPopup', Record<never, never>, Record<never, never>>,
    '/maps/components/MapToolkit': RouteRecordInfo<'/maps/components/MapToolkit', '/maps/components/MapToolkit', Record<never, never>, Record<never, never>>,
    '/maps/components/MapViewport': RouteRecordInfo<'/maps/components/MapViewport', '/maps/components/MapViewport', Record<never, never>, Record<never, never>>,
