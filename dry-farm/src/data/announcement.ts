...
export const announcementsData: Announcement[] = [
  ...
  fullContent: '20260612 系統新上線功能如下 \n\n🔐 1. 資安功能重要更新（上線後生效）\n為符合最新資安規範，登入機制將有以下調整：\n\n定期換密碼： 每 3 個月系統將強制要求變更密碼。\n\n密碼長度變長： 密碼最小長度提升至 12 碼。\n\n傳輸加密安全： 密碼傳輸全程加密防護。\n\n⚙️ 2. 系統改善與優化\n已編列計算調整： 首頁已編列預算，變更為「建立土地資料後」即列入計算。\n\n補助金額： 每人補助上限 500,000 元，超出金額將自動轉為自備額。\n\nGIS 圖台優化： 相同點位調整為「不聚合」，以利呈現舊申請點位。\n\nBug 修正： 修正變更設計功能及補助申請明細表問題。'
  },
   {
    id: 7,
  date: '115.04.13',
