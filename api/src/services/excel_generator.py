...
_A0910_NOTE_TEXT = (
    ...
    '2、「已結案」係指 status 為 completed 或 submitted 之案件；「已編列」係指案件「成立」後，未結案之所有有效案件。'
)
...
class ExcelGeneratorService:
    ...
    async def generate_subsidy_details_list(
        ...
        Args:
            grants_by_sheet: {'農水署明細表': [...], '瑠公明細表': [...], '七星明細表': [...], '作業基金明細表': [...]}
            year: 民國年字串（如 '114'）
        ...
        for sheet_name in ['農水署明細表', '瑠公明細表', '七星明細表', '作業基金明細表']:
