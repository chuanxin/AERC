...
@router.post(
    ...
    dependencies=[Depends(require_permission(ModuleName.OFFICES, PermissionAction.CREATE))],
)
...
@router.put(
    ...
    response_model=OfficeOutSchema,
    status_code=status.HTTP_200_OK,
    dependencies=[Depends(require_permission(ModuleName.OFFICES, PermissionAction.EDIT))],
)
...
@router.delete(
    "/offices/{office_id}",
    status_code=status.HTTP_200_OK,
    dependencies=[Depends(require_permission(ModuleName.OFFICES, PermissionAction.DELETE))],
)
